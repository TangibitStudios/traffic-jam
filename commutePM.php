...
$request = Requests::get('https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&mode=driving&departure_time=now&origins=YOUR_WORK_ADDRESS&destinations=YOUR_HOME_ADDRESS&key=YOUR_API_KEY');
